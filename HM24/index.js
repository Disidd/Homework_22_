...
const userNumber = users
  ...
  console.log("phone numbers of users as they have balance more 2000$");
  console.log(userNumber);

  // знайти суму всіх балансів користувачів
  const sumOfBalance = users
  .reduce(function(sum, user) {
    return sum + parseFloat(user.balance.replace('$', '').replace(',', ''));
  }, 0);

  console.log("the sum of all users balances");
